...
namespace RunAndJump {
	public class Background : MonoBehaviour {
		...
		private void CreateInstance(int xPos, int yPos) {
         ...
         //   go.transform.position = _bg.bounds.extents;
            //go.transform.position = _boundsCam.transform.position + new Vector3((_bg.bounds.extents.x * 1), (_bg.bounds.extents.y * 1), 0);
